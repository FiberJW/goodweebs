...
export const GetGenresDocument = gql`
  ...
  GenreCollection
    ...
    `;
export type GetGenresComponentProps = Omit<ApolloReactComponents.QueryComponentOptions<GetGenresQuery, GetGenresQueryVariables>, 'query'>;

    export const GetGenresComponent = (props: GetGenresComponentProps) => (
      <ApolloReactComponents.Query<GetGenresQuery, GetGenresQueryVariables> query={GetGenresDocument} {...props} />
    );
    
export type GetGenresProps<TChildProps = {}, TDataName extends string = 'data'> = {
      [key in TDataName]: ApolloReactHoc.DataValue<GetGenresQuery, GetGenresQueryVariables>
    } & TChildProps;
export function withGetGenres<TProps, TChildProps = {}, TDataName extends string = 'data'>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  GetGenresQuery,
  GetGenresQueryVariables,
  GetGenresProps<TChildProps, TDataName>>) {
    return ApolloReactHoc.withQuery<TProps, GetGenresQuery, GetGenresQueryVariables, GetGenresProps<TChildProps, TDataName>>(GetGenresDocument, {
      alias: 'getGenres',
      ...operationOptions
    });
};
