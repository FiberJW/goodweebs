...
export type GetAnimeListQuery = { __typename?: "Query" } & {
  MediaListCollection?: Maybe<
    { __typename?: "MediaListCollection" } & Pick<
      MediaListCollection,
      "hasNextChunk"
    > & {
        lists?: Maybe<
...
export type GetViewerQueryVariables = object;

export type GetViewerQuery = { __typename?: "Query" } & {
  Viewer?: Maybe<
    { __typename?: "User" } & Pick<User, "id" | "name"> & {
        avatar?: Maybe<
          { __typename?: "UserAvatar" } & Pick<UserAvatar, "large" | "medium">
        >;
      }
  >;
};
...
`;
export type GetAnimeListComponentProps = Omit<
...
export const GetAnimeListComponent = (props: GetAnimeListComponentProps) => (
  <ApolloReactComponents.Query<GetAnimeListQuery, GetAnimeListQueryVariables>
    query={GetAnimeListDocument}
    {...props}
  />
);

export type GetAnimeListProps<
  TChildProps = object,
...
> = {
  ...
  TChildProps;
export function withGetAnimeList<
  TProps,
  TChildProps = object,
  TDataName extends string = "data"
>(
...
export type GetAnimeListQueryResult = ApolloReactCommon.QueryResult<
  GetAnimeListQuery,
  GetAnimeListQueryVariables
>;
...
`;
export type GetViewerComponentProps = Omit<
  ApolloReactComponents.QueryComponentOptions<
    GetViewerQuery,
...
export const GetViewerComponent = (props: GetViewerComponentProps) => (
  <ApolloReactComponents.Query<GetViewerQuery, GetViewerQueryVariables>
    query={GetViewerDocument}
    {...props}
  />
);

export type GetViewerProps<
  TChildProps = object,
  TDataName extends string = "data"
> = {
  [key in TDataName]: ApolloReactHoc.DataValue<
